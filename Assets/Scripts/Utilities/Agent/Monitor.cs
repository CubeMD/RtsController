...
namespace Utilities.Agent
{
    ...
    public class Monitor : MonoBehaviour
    {
        ...
        /// transform.
        /// </summary>
        static Dictionary<Transform, UnityEngine.Camera> s_TransformCamera;
        ...
        static void InstantiateCanvas()
        {
            ...
            s_TransformCamera = new Dictionary<Transform, UnityEngine.Camera>();
        }
